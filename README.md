...
- **清晰的结果可视化**：每个目标上方绘制带彩色底纹的水平标签，显示序号、模板 ID、得分、尺度、坐标和角度；左上角统计信息同样带自适应底纹。外包围框使用避开红色和绿色的稳定高对比色，所有图形均安全裁剪。
...
结果图标签格式为 `#1 T1 S0.925 M1.00 C123.2,453.2,135.5`，依次表示
目标序号、模板号、得分、缩放比例以及 `x,y,angle`。字体、底纹、边距和线宽会
依据图像尺寸缩放；标签优先放在目标上方，空间不足时自动选择下方或侧边位置。
...
|---|---:|---|---:|
| src1_2_3 | 33 | 1:12, 2:9, 3:12 | 973.894 |
| src4 | 3 | 4:3 | 149.363 |
...
| src7_8 | 1 | 7:1 | 98.313 |
| src8 | 7 | 8:7 | 255.111 |
| src9_1 | 4 | 9:2, 10:2 | 310.087 |
| src9_2 | 8 | 9:4, 10:3, 11:1 | 427.167 |
| src9_3 | 5 | 10:4, 11:1 | 303.056 |
| src9_4 | 4 | 9:2, 10:1, 11:1 | 413.210 |
| src9_5 | 3 | 9:3 | 377.035 |
| src9_6 | 4 | 9:3, 11:1 | 641.879 |
| src9_7 | 5 | 9:2, 10:2, 11:1 | 340.823 |
| src9_8 | 5 | 10:4, 11:1 | 374.005 |
| src9_9 | 4 | 9:2, 10:2 | 401.999 |
| src9_10 | 4 | 9:2, 10:1, 11:1 | 350.087 |
| src9_11 | 3 | 9:1, 10:1, 11:1 | 360.690 |
| src9_12 | 3 | 10:3 | 333.876 |
| src9_13 | 2 | 9:2 | 279.067 |
